...
namespace BookingHotel.Core.Services
{
    public class BookingService : IBookingService
    {
        ...
        //booking => check rooms have registered or not => check price => create booking
        public async Task CreateBooking(BookingDTO booking)
        {
            ...
            if(newBooking.Room.Status == true)
            {
                throw new Exception("This room has been registered");
            }

            _ = _bookingRepository.CreateBooking(newBooking);
